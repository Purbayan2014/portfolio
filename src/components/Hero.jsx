...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">Her0
      ...
      flex-row items-start gap-5`}>
        ...
        <div>
          ...
          text-white`}>Hi, I'm <span className="text-[#915eff]">Purbayan</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I am final year undergrad student , an aspiring full stack developer and I am capable of developing
            machine learning / deep learning web applications and networking  protocols
          </p>
        </div>
      </div>
